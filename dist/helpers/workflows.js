...
const introComment = async () => `# This file was generated by biginvn/uptime-monitor@${await exports.getUptimeMonitorVersion()}
#
# ===============================
...
jobs:
  release:
    ...
    steps:
      ...
      - name: Generate graphs
        uses: biginvn/uptime-monitor@${await exports.getUptimeMonitorVersion()}
        with:
          command: "graphs"
        env:
